...
const PLAYERS: SeedPlayer[] = [
  ...
  },
  {
    ...
    displayName: "Carter Armstrong",
    email: "carter@rydeher.local",
    team: "hookers",
    isAdmin: false,
    ghin: "1000005",
    index: 10.3,
...
async function main() {
  ...
  try {
    ...
    for (const p of PLAYERS) {
      await client.query(
        `INSERT INTO invite_list (email, display_name, is_admin)
         VALUES ($1, $2, $3)`,
        [p.email, p.displayName, p.isAdmin],
      );
    ...
    await seedBestBallMatch(client, {
      id: MATCH_IDS.thuAm2,
      label: "Match 2 · Bolton / Jonas vs Fischer / McClennan",
      sortOrder: 2,
      sessionId: sessionByRound[1]!,
      format: "best_ball_match",
      visibility: "live",
      ...
      pairings: [
        ...
        { name: "Mike Fischer", side: "slicers" },
        { name: "Bryan McClennan", side: "slicers" },
      ],
      holesPlayed: 18,
      hookersBias: 0.35,
    });
    ...
    await seedTeamBallMatch(client, {
      ...
      status: "in_progress",
      pairings: [
        { name: "Carter Armstrong", side: "hookers" },
    ...
    await seedBestBallMatch(client, {
      ...
      label: "Your match · Peek / Bolton vs Sarier / Fischer",
      sortOrder: 6,
    ...
    await seedBestBallMatch(client, {
      id: MATCH_IDS.satPm3,
      label: "Singles · Bolton vs Fischer",
      sortOrder: 9,
      sessionId: sessionByRound[6]!,
      format: "singles_match",
      visibility: "live",
    ...
    await seedBestBallMatch(client, {
      id: MATCH_IDS.satPm4,
      label: "Singles · Jonas vs McClennan",
      sortOrder: 10,
      sessionId: sessionByRound[6]!,
      format: "singles_match",
      visibility: "live",
    ...
    await applyWholeFieldSkins(client, {
      ...
      awards: [
        ...
        { hole: 6, winner: "Mike Fischer", gross: 4 },
        { hole: 7, winner: "Kyle Jonas", gross: 2 },
        { hole: 8, winner: "Bryan McClennan", gross: 3 },
